...
![ANTI-ADHD 로고](/api/placeholder/200/100 "ANTI-ADHD 로고")
...
[![다운로드 버튼](/api/placeholder/200/50 "다운로드 버튼")](https://github.com/octxxiii/Anti-ADHD/releases/latest/download/ANTI_ADHD.exe)
...
![MIT License](/api/placeholder/80/30 "MIT License")
